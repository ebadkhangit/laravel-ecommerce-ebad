								...
								<div class="row">
                                    <div class="col-md-12">
										<div class="mb-3">
											...
											<select name="category" id="category" class="form-control">
                                                ...
                                                <option <?php echo e(($subCategory->category_id ==  $category->id) ? 'selected' : ''); ?>  value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?>
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug" value="<?php echo e($subCategory->slug); ?>">
											<p></p>	
										</div>
									</div>	
										...
										<div class="mb-3">
											...
											<select name="status" id="status" class="form-control" >
												...
												<option <?php echo e(($subCategory->status == 0) ? 'selected' : ''); ?>  value="0">Block</option>
											</select>
											<p></p>	
										</div>
									</div>									
