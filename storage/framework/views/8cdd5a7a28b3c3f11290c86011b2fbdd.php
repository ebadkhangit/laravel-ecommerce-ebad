					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="<?php echo e(route('categories.create')); ?>" class="btn btn-primary">New Category</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
											...
											<td>
												...
												<a href="#" onclick="deleteCategory(<?php echo e($category->id); ?>)" class="text-danger w-4 h-4 mr-1">
	...
	function deleteCategory(id) {
     ...
     $.ajax({
            ...
            //if(response["status"]){
		 			...
		 			//.location.href = "<?php echo e(route('categories.index')); ?>";
	//} 
