					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="<?php echo e(route('sub-categories.create')); ?>" class="btn btn-primary">New Sub Category</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
					...
					<div class="container-fluid">
						...
						<div class="card">
							...
							<div class="card-header">
						       <div clas="card-title">
						      <button type="button"  class="btn btn-default btn-sm" onclick="window.location.href='<?php echo e(route("sub-categories.index")); ?>'">Reset</button> 
						      </div>	
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
											...
											<td>
												...
												<a href="#" onclick="deleteSubCategory(<?php echo e($subCategory->id); ?>)" class="text-danger w-4 h-4 mr-1">
...
<script>
	...
	function deleteSubCategory(id) {
		...
		var  url = '<?php echo e(route("sub-categories.delete","ID")); ?>';
